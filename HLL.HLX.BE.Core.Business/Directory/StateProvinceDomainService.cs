...
{
    public class StateProvinceDomainService : DomainService
    {
        #region Constants
        ...
        /// </remarks>
        private const string STATEPROVINCES_ALL_KEY = "Hlx.stateprovince.all-{0}-{1}-{2}";
        /// <summary>
        /// Key pattern to clear cache
        /// </summary>
        private const string STATEPROVINCES_PATTERN_KEY = "Hlx.stateprovince.";

        private const string CACHE_NAME_STATEPROVINCE = "cache.stateprovince";
        #endregion
        ...
        public StateProvinceDomainService(ICacheManager cacheManager,
        ...
        public virtual void DeleteStateProvince(StateProvince stateProvince)
        {
            ...
            _cacheManager.GetCache(CACHE_NAME_STATEPROVINCE).Clear();
        ...
        public virtual StateProvince GetStateProvinceById(int stateProvinceId)
        {
            ...
            return _stateProvinceRepository.FirstOrDefault(stateProvinceId);
        }
        ...
        {
            var query = from sp in _stateProvinceRepository.GetAll()
        ...
        public virtual IList<StateProvince> GetStateProvincesByCountryId(int countryId, int languageId = 0, bool showHidden = false)
        {
            ...
            return _cacheManager.GetCache(CACHE_NAME_STATEPROVINCE).Get(key, () =>
            {
                var query = from sp in _stateProvinceRepository.GetAll()
