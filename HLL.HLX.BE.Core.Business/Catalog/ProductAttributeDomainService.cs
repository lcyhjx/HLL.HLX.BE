...
{
    public class ProductAttributeDomainService : DomainService
    {
        #region Constants
        /// <summary>
        /// Key for caching
        ...
        /// name for cache
        /// </summary>
        private const string CACHE_NAME_PRODUCTATTRIBUTES = "cache.productattribute";
        private const string CACHE_NAME_PRODUCTATTRIBUTEMAPPINGS = "cache.productattributemapping";
        private const string CACHE_NAME_PRODUCTATTRIBUTECOMBINATIONS = "cache.productattributecombination";
        private const string CACHE_NAME_PRODUCTATTRIBUTEVALUES = "cache.productattributevalue";        
        ...
        private readonly IPredefinedProductAttributeValueRepository _predefinedProductAttributeValueRepository;
        ...
        public virtual IList<ProductAttributeMapping> GetProductAttributeMappingsByProductId(int productId)
        {
            ...
            return _cacheManager.GetCache(CACHE_NAME_PRODUCTATTRIBUTEMAPPINGS).Get(key, () =>
            {
                var query = from pam in _productAttributeMappingRepository.GetAll()
        ...
        public virtual ProductAttributeMapping GetProductAttributeMappingById(int productAttributeMappingId)
        {
            ...
            return _cacheManager.GetCache(CACHE_NAME_PRODUCTATTRIBUTEMAPPINGS).Get(key, () => _productAttributeMappingRepository.FirstOrDefault(productAttributeMappingId));
        }
        ...
        public virtual IList<ProductAttributeValue> GetProductAttributeValues(int productAttributeMappingId)
        {
            ...
            return _cacheManager.GetCache(CACHE_NAME_PRODUCTATTRIBUTEVALUES).Get(key, () =>
            {
                var query = from pav in _productAttributeValueRepository.GetAll()
        ...
        public virtual ProductAttributeValue GetProductAttributeValueById(int productAttributeValueId)
        {
            ...
            return _cacheManager.GetCache(CACHE_NAME_PRODUCTATTRIBUTEVALUES).Get(key, () => _productAttributeValueRepository.FirstOrDefault(productAttributeValueId));
        }
        ...
        {
            var query = from ppav in _predefinedProductAttributeValueRepository.GetAll()
        ...
        public virtual PredefinedProductAttributeValue GetPredefinedProductAttributeValueById(int id)
        {
            ...
            return _predefinedProductAttributeValueRepository.FirstOrDefault(id);
        }
        ...
        public virtual IList<ProductAttributeCombination> GetAllProductAttributeCombinations(int productId)
        {
            ...
            return _cacheManager.GetCache(CACHE_NAME_PRODUCTATTRIBUTECOMBINATIONS).Get(key, () =>
            {
                var query = from c in _productAttributeCombinationRepository.GetAll()
                            orderby c.Id
        ...
        public virtual ProductAttributeCombination GetProductAttributeCombinationById(int productAttributeCombinationId)
        {
            ...
            return _productAttributeCombinationRepository.FirstOrDefault(productAttributeCombinationId);
        }
        ...
        public virtual ProductAttributeCombination GetProductAttributeCombinationBySku(string sku)
        {
            ...
            var query = from pac in _productAttributeCombinationRepository.GetAll()
                        orderby pac.Id
                        where pac.Sku == sku
                        select pac;
