...
namespace HLL.HLX.BE.Core.Business.Catalog
{
    ...
    public class ProductDomainService : DomainService
    {
        ...
        public ProductDomainService(ICacheManager cacheManager,
        ...
        public virtual Product GetProductById(int productId)
        {
            ...
            return _cacheManager.GetCache(CACHE_NAME_PRODUCT).Get(key, () => _productRepository.FirstOrDefault(productId));
        }
        ...
        public virtual void InsertProduct(Product product)
        {
            ...
            //clear cache
            _cacheManager.GetCache(CACHE_NAME_PRODUCT).Clear();
            ...
            bool? overridePublished = null)
        {
            ...
            #region UseStoredProceduresIfSupported
            ////Access control list. Allowed customer roles
            //var allowedCustomerRolesIds = _workContext.CurrentCustomer.GetCustomerRoleIds();

            //if (CommonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
            //{
            ...
            #endregion
            {
                ...
                if (loadFilterableSpecificationAttributeOptionIds)
                {
                    var querySpecs = from p in query
                                     join psa in _productSpecificationAttributeRepository.GetAll() on p.Id equals psa.ProductId
            ...
            out IList<ProductAttributeCombination> combinations)
        {
            ...
            var query1 = from p in _productRepository.GetAll()
            ...
            var query2 = from p in _productRepository.GetAll()
        ...
        public virtual void AdjustInventory(Product product, int quantityToChange, string attributesXml = "")
        {
            ...
            if (product.ManageInventoryMethod == ManageInventoryMethod.ManageStock)
            {
                ...
                if (CatalogSettings.PublishBackProductWhenCancellingOrders)
                {
        ...
        {
            var query = from rp in _relatedProductRepository.GetAll()
                        join p in _productRepository.GetAll() on rp.ProductId2 equals p.Id
        ...
        public virtual RelatedProduct GetRelatedProductById(int relatedProductId)
        {
            ...
            return _relatedProductRepository.FirstOrDefault(relatedProductId);
        }
        ...
        {
            var query = from csp in _crossSellProductRepository.GetAll()
                        join p in _productRepository.GetAll() on csp.ProductId2 equals p.Id
        ...
        public virtual CrossSellProduct GetCrossSellProductById(int crossSellProductId)
        {
            ...
            return _crossSellProductRepository.FirstOrDefault(crossSellProductId);
        }
        ...
        public virtual TierPrice GetTierPriceById(int tierPriceId)
        {
            ...
            return _tierPriceRepository.FirstOrDefault(tierPriceId);
        }
        ...
        public virtual ProductPicture GetProductPictureById(int productPictureId)
        {
            ...
            return _productPictureRepository.FirstOrDefault(productPictureId);
        }
        ...
        public virtual ProductReview GetProductReviewById(int productReviewId)
        {
            ...
            return _productReviewRepository.FirstOrDefault(productReviewId);
        }
        ...
        public virtual IList<ProductReview> GetProducReviewsByIds(int[] productReviewIds)
        {
            ...
            var query = from pr in _productReviewRepository.GetAll()
