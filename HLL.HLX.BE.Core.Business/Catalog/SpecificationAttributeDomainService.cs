...
{
    public partial class SpecificationAttributeDomainService : DomainService
    {
        #region Constants
        ...
        private const string CACHE_NAME_PRODUCTSPECIFICATIONATTRIBUTE = "cache.productspecificationattribute";
        #endregion
        ...
        public virtual SpecificationAttribute GetSpecificationAttributeById(int specificationAttributeId)
        {
            ...
            return _specificationAttributeRepository.FirstOrDefault(specificationAttributeId);
        }
        ...
        {
            var query = from sa in _specificationAttributeRepository.GetAll()
        ...
        public virtual SpecificationAttributeOption GetSpecificationAttributeOptionById(int specificationAttributeOptionId)
        {
            ...
            return _specificationAttributeOptionRepository.FirstOrDefault(specificationAttributeOptionId);
        }
        ...
        public virtual IList<SpecificationAttributeOption> GetSpecificationAttributeOptionsByIds(int[] specificationAttributeOptionIds)
        {
            ...
            var query = from sao in _specificationAttributeOptionRepository.GetAll()
            ...
            int specificationAttributeOptionId = 0, bool? allowFiltering = null, bool? showOnProductPage = null)
        {
            ...
            return _cacheManager.GetCache(CACHE_NAME_PRODUCTSPECIFICATIONATTRIBUTE).Get(key, () =>
            {
                var query = _productSpecificationAttributeRepository.GetAll();
                if (productId > 0)
        ...
        public virtual ProductSpecificationAttribute GetProductSpecificationAttributeById(int productSpecificationAttributeId)
        {
            ...
            return _productSpecificationAttributeRepository.FirstOrDefault(productSpecificationAttributeId);
        }
