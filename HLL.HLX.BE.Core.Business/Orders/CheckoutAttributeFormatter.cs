...
namespace HLL.HLX.BE.Core.Business.Orders
{
    ...
    public partial class CheckoutAttributeFormatter : ICheckoutAttributeFormatter
    {
        ...
        private readonly DownloadDomainService _downloadService;
           ...
           , Currency workingCurrency)
        {
            ...
            return FormatAttributes(attributesXml, customer, workingCurrency);
        }
                        ...
                        if (int.TryParse(valueStr, out attributeValueId))
                        {
                            ...
                            if (attributeValue != null)
                            {
                                ...
                                if (renderPrices)
                                {
                                    ...
                                    {
                                        string priceAdjustmentStr = _priceFormatter.FormatPrice(priceAdjustment,true, workingCurrency);
