...
namespace HLL.HLX.BE.Core.Model.Catalog
{
    ...
    /// </summary>
    public class Product : FullAuditedEntity<int,User> , IStoreMappingSupported
    {
        ...
        /// <summary>
        ///     Gets or sets the parent product identifier. It's used to identify associated products (only with "grouped"
        ///     products)
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the start date and time of the new product (set product as "New" from date). Leave empty to ignore
        ///     this property
        /// </summary>
        public DateTime? MarkAsNewStartDateTimeUtc { get; set; }

        /// <summary>
        ///     Gets or sets the end date and time of the new product (set product as "New" to date). Leave empty to ignore this
        ///     property
        /// </summary>
        ...
        /// <summary>
        ///     Gets or sets the collection of "ProductWarehouseInventory" records. We use it only when "UseMultipleWarehouses" is
        ///     set to "true" and ManageInventoryMethod" to "ManageStock"
        /// </summary>
