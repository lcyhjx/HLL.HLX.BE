...
namespace HLL.HLX.BE.Application.Common
{
    public static class MappingExtensions
    {
            ...
            string overrideAttributesXml = "")
        {
            ...
            if (addressSettings.CountryEnabled && loadCountries != null)
            {
                ...
                model.AvailableCountries.Add(new SelectListItemDto { Text = InfoMsg.Address_SelectCountry, Value = "0" });
                ...
                if (addressSettings.StateProvinceEnabled)
                {
                    ...
                    if (states.Count > 0)
                    {
                        model.AvailableStates.Add(new SelectListItemDto { Text = InfoMsg.Address_SelectState, Value = "0" });
