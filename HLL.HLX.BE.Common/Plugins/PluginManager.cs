...
using HLL.HLX.BE.Common.Plugins;
...
namespace HLL.HLX.BE.Common.Plugins
{
    /// <summary>
    ...
    public class PluginManager
    {
            ...
            using (new WriteLockDisposable(Locker))
            {
                ...
                try
                {
                    ...
                    foreach (var dfd in GetDescriptionFilesAndDescriptors(pluginFolder))
                    {
                        ...
                        if (!pluginDescriptor.SupportedVersions.Contains(HlxVersion.CurrentVersion, StringComparer.InvariantCultureIgnoreCase))
                        {
        ...
        private static Assembly PerformFileDeploy(FileInfo plug)
        {
            ...
            if (CommonUtil.GetTrustLevel() != AspNetHostingPermissionLevel.Unrestricted)
            {
